-- Add total_draws (W-D-L) to profile card.
...
COMMENT ON FUNCTION public.get_user_profile_card(UUID) IS 'Public profile card: username, avatar_url, bio, level, xp, w-d-l, quizzes, wins, losses, correct/incorrect, joined_at, country.';
