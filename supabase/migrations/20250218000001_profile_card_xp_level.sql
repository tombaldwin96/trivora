-- Add xp and level to get_user_profile_card for leaderboard profile modal.
...
BEGIN
  ...
  SELECT username, country, created_at, xp, level
  INTO v_username, v_country, v_created_at, v_xp, v_level
