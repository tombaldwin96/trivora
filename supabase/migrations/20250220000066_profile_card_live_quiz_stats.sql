-- Add Live quizzes participated, Live quiz top 10 finish, and Live quiz wins to get_user_profile_card.
...
COMMENT ON FUNCTION public.get_user_profile_card(UUID, UUID) IS 'Public profile card. Includes live_quiz_win_count, live_quizzes_participated, live_quiz_top_10_finishes. When p_viewer_id provided, includes h2h.';
