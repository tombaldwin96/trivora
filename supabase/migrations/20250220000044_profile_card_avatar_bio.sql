-- Add avatar_url and bio to profile card (leaderboard modal).
...
COMMENT ON FUNCTION public.get_user_profile_card(UUID) IS 'Public profile card for leaderboard: username, avatar_url, bio, level, xp, quizzes, wins, losses, correct/incorrect, joined_at, country (when set).';
